      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:compdept@pestrust.edu.in" className="text-blue-100 hover:underline">compdept@pestrust.edu.in</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className={cn(
            ...
            <form className="bg-white/10 backdrop-blur-sm p-8 rounded-lg shadow-lg">
